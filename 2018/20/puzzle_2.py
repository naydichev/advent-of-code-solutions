...
def main(raw):
    ...
    print("there are {} paths that go through 1000 doors".format(doors))
...
def find_path(grid):
    ...
    more_than_thousand_doors = len(filter(lambda k: len(k.doors) >= 1000, distance.values()))

    return more_than_thousand_doors
