...
def main(raw_gates):
    ...
    process_gates(deps, wire_to_gate)

    wire_a = WIRES['a']
    WIRES = {}
    wire_to_gate['b'] = Gate(OPERATIONS[ASSIGNED], (wire_a,), "b", ASSIGNED)
    process_gates(deps_copy, wire_to_gate)
...
def process_gates(dependencies, wire_to_gate):
